# Laoding the Indy Fair Donuts (IFD) i.e Food and Beverage Company Data set
ifd <- read.csv("~/Downloads/indy.fair.data.csv")
...
# Checking no. of row in new dataframe
nrow(store_only)
...
# Correlation analysis between turnover and probable key predictors
